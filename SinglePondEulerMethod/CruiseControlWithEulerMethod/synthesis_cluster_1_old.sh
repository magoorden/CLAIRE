...
QUERY_PATH=CruiseControlWithEulerMethod/cruise_minmax_corrected_new_method_old.q
RESULT_PATH=CruiseControlWithEulerMethod/cruise_minmax_corrected_new_method_result_old.txt

...
\begin{frame}{Comparison with 20 minutes control period}
	\centering
	\begin{tikzpicture}
		% To plot figure with multiple ordinates, see section 4.9.11 of the pgfplot manual.
		pgfplotsset{set layers}
		\begin{axis}[
			...
			table[x expr=\thisrowno{0} / 60,y expr=\thisrowno{1} * 30 + 600, col sep=comma]{data/optimal/Control_stateData.csv};
			\addlegendentry{$P=10$ setting}
			
			\addplot[
			color=red,
			]
			table[x expr=\thisrowno{0} / 60,y index = 1, col sep=comma]{../OnlineControlExperiment4/data/optimal/DepthData.csv};
			\addlegendentry{$P=20$}
			...
			table[x expr=\thisrowno{0} / 60,y expr=\thisrowno{1} * 30 + 600, col sep=comma]{../OnlineControlExperiment4/data/optimal/Control_stateData.csv};
			\addlegendentry{$P=20$ setting}			
